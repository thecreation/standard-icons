...
let options = {
  ...
  name: 'fontisto-brands',
  class: 'fib',
  prefix: 'fib-',
  className: 'FontistoBrands',
  title: 'Fontisto Brands',
  classifiable: false
};
...
let paths = {
  ...
  css: path.join(options.source, 'css', 'fontisto', 'fontisto-brands.css'),
...
options.fonts = getFonts(paths.fonts, 'fontisto-brands*');
