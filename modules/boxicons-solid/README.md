...
```scss
@import "@icon/boxicons-solid/index.scss";
```
...
For a compiled **CSS** version of this module, an npm script is included that will output a css version to `dist/boxicons-solid.css` The built css file is also included in the npm package:
