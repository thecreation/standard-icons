...
let options = {
  ...
  name: 'fontisto-medical',
  class: 'fim',
  prefix: 'fim-',
  className: 'FontistoMedical',
  title: 'Fontisto Medical',
  classifiable: false
};
...
let paths = {
  ...
  css: path.join(options.source, 'css', 'fontisto', 'fontisto-medical.css'),
...
options.fonts = getFonts(paths.fonts, 'fontisto-medical*');
