...
let options = {
  ...
  class: 'fiem',
  prefix: 'fiem-',
  className: 'FontistoEmoji',
  title: 'Fontisto Emoji',
  classifiable: false
};
...
let paths = {
  ...
  css: path.join(options.source, 'css', 'fontisto', 'fontisto-emoji.css'),
...
options.fonts = getFonts(paths.fonts, 'fontisto-emoji*');
