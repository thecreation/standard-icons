...
let options = {
  ...
  name: 'fontisto-travel',
  class: 'fit',
  prefix: 'fit-',
  className: 'FontistoTravel',
  title: 'Fontisto Travel',
  classifiable: false
};
...
let paths = {
  ...
  css: path.join(options.source, 'css', 'fontisto', 'fontisto-travel.css'),
...
options.fonts = getFonts(paths.fonts, 'fontisto-travel*');
