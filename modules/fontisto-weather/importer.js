...
let options = {
  ...
  name: 'fontisto-weather',
  class: 'fiw',
  prefix: 'fiw-',
  className: 'FontistoWeather',
  title: 'Fontisto Weather',
  classifiable: false
};
...
let paths = {
  ...
  css: path.join(options.source, 'css', 'fontisto', 'fontisto-weather.css'),
...
options.fonts = getFonts(paths.fonts, 'fontisto-weather*');
