...
[![npm version](https://img.shields.io/npm/v/@icon/support.svg)](https://www.npmjs.org/package/@icon/support)
...
This repository is distributed with [npm]. After [installing npm][install-npm], you can install `@icon/support` with this command.

```bash
npm install --save @icon/support
```
...
```scss
@import "@icon/support/index.scss";
```
